...
venue: "Third Cave on the left"        # brief name of host site without address (e.g., "Euphoric State University")
address: "354"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Peter, Louise, Kelsey, Yalbi"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
